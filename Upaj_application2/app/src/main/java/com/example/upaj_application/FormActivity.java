...
//    Button userdashboard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        predictdisease = findViewById(R.id.predict_disease);
//        userdashboard = findViewById(R.id.user_dashboard);
        ...
        predictdisease.setOnClickListener((v)->{
            startActivity(new Intent(FormActivity.this,predictdisease.class));
        });
